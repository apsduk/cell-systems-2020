    ...
    for i_2 = 1:length(v_betaf) % betafC
        for i_3 = 1:length(v_betaf) % betafA
            for i_4 = 1:length(v_betaf) % betafF
                for i_5 = 1:length(v_xif_const_1) % xifC
                    for i_6 = 1:length(v_xif_const_1) % xifA
                        for i_7 = 1:length(v_xif_const_2) % xifF
                            for i_8 = 1:length(v_proteins) % translational repressor
                                ...
                                X00(fid, 7) = v_xif_const_1;         % xifC
                                X00(fid, 8) = v_xif_const_1;         % xifA
...
parfor i = 1:length(X0(:,1))
    ...
    % ODES
    f_1 = @(T,Y) var_frag_or(T, Y, [X(2:9), X(2:9)], [X(11:18)], [X(20:25)], [X(26:31)], [    0,    0, X(10), X(19), X(42)], [X(32:41)], [X(43:53)]);
    f_2 = @(T,Y) var_frag_or(T, Y, [X(2:9), X(2:9)], [X(11:18)], [X(20:25)], [X(26:31)], [ X(1),    0, X(10), X(19), X(42)], [X(32:41)], [X(43:53)]);
    f_3 = @(T,Y) var_frag_or(T, Y, [X(2:9), X(2:9)], [X(11:18)], [X(20:25)], [X(26:31)], [ X(1), X(1), X(10), X(19), X(42)], [X(32:41)], [X(43:53)]);
