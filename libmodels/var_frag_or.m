function dY = dualcontroller_9o(T, Y, circPR, ornapPR, oriboPR, hostPR, plasmidPR, rnapcontPR, ribocontPR)
...
%% core o-RNAP
dxC = xifC*gC*oP - (xirC + tauC)*xC - lambda*xC;
...
%% alpha o-RNAP
dxA = xifA*gA*oP - (xirA + tauA)*xA - lambda*xA;
...
doP = oleak + alphafA*pA*pC - alpharA*oP ...
    ...
    - xifC*gC*oP + (xirC + tauC)*xC ...
    - xifA*gA*oP + (xirA + tauA)*xA;
...
% dg2 = omegag2 - xif2*g2*oP + (xir2 + tau2)*x2 - lambda*g2;
...
%% return dYdt
dY = [dxC; dmC; dcC; dpC; dxA; dmA; dcA; dpA; doP; ...
    dxR; drR; doR; ...
